...
class EditProduk(wx.Dialog):
    def __init__(self, parent):
        ...
        self.input_supplier = wx.ComboBox(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
        ...
        self.input_produk = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        self.input_jumlah = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        # Connect Events
        # self.input_supplier.Bind(wx.EVT_COMBOBOX, self.input_supplierOnCombobox)
        # self.btn_batal.Bind(wx.EVT_BUTTON, self.btn_batalOnButtonClick)
        # self.btn_simpan.Bind(wx.EVT_BUTTON, self.btn_simpanOnButtonClick)
